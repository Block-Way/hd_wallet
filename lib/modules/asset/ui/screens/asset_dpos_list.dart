...
//      final res = await AssetRepository().getTransactionFee(symbol: coinInfo.symbol, address: coinInfo.address);
//      final resVoteNode = await AssetRepository().getVoteNode();
//      return resVoteNode.length;
//
//    }

//    var voteNodeList = null;
//    AssetRepository().getVoteNode().then((res) => {
//      print("====================> kkkkkk   $res"),
//      voteNodeList = res,
//
//      print("voteNodeList $voteNodeList")
//    });
